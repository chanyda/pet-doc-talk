import { Controller, Post, Get, Body, Param, Query, ParseIntPipe, Sse, HttpCode, HttpStatus } from "@nestjs/common";
...
export class ConsultationMessagesController {
    ...
    sendMessage(
        ...
        return this.consultationMessagesService.sendMessageStream(userId, consultationId, sendMessageDto);
    }
}
