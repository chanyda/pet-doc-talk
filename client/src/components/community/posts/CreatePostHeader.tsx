export function CreatePostHeader() {
    return (
        <>
            <div>
                <h1 className="text-3xl mb-2">게시글 작성</h1>
                <p className="text-gray-600">반려동물과 관련된 이야기를 자유롭게 공유해보세요.</p>
            </div>

            <div className="mt-5 mb-5 bg-gradient-to-r from-pink-50 to-orange-50 rounded-xl p-6 border border-pink-100">
                <h3 className="font-medium text-gray-900 mb-3">게시글 작성 팁</h3>
