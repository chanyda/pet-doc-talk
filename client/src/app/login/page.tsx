        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="max-w-md mx-auto px-4 md:px-6 py-8 md:py-12">
                <div className="bg-white rounded-2xl shadow-sm p-6 md:p-8">
                    <h1 className="text-2xl md:text-3xl font-bold mb-2 text-center" style={{ color: "var(--brand-pink)" }}>
                        로그인
                    </h1>
                    <p className="text-sm md:text-base text-gray-600 text-center mb-6 md:mb-8">펫닥톡에 오신 것을 환영합니다</p>
